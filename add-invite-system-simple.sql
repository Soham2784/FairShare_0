-- Add invite system to groups (simple version)
-- This adds invite code functionality without complex RLS policies

-- Add invite_code columns to groups table
...
-- Add RLS policy for invite code access (allow anyone to view groups by invite code)
